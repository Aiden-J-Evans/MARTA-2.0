...
class Renderer:
  def __init__(self):
    self.render_floor_plain((0, 0, 0), (100, 100, 1), "C:/Users/aiden/Pictures/Camera Roll/test.jpg", (1, 1))


  def render_floor_plain(self, location=(0, 0, 0), scale=(10, 10, 1), image_path="", tile_size=(1, 1)):
    """
  ...
  def render_skybox(self, image_path=""):
    """
